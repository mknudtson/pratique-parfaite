...
// _x_ local storage - for user-inputted vocabulary
...
function createAndShow(){
    ...
    vocabulary.push({ // push object to array
        EN: inputEN,
        FR: inputFR
    });
    ...
    showVocabList();
    // add to localStorage by looping
    for (let i = 0; i < vocabulary.length; i++) {
        localStorage.setItem('pair', [vocabulary[i].EN, vocabulary[i].FR]); // 
        var localPair = localStorage.getItem('pair')
